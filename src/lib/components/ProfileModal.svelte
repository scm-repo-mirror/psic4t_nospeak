...
{#if isOpen}
    ...
    >
        <div class="bg-white/95 dark:bg-slate-900/85 backdrop-blur-xl w-full max-w-xl h-auto max-h-[85vh] rounded-3xl flex flex-col shadow-2xl border border-white/20 dark:border-white/10 overflow-hidden relative outline-none">
