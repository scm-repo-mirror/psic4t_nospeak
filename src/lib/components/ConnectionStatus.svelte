...
<div class="p-2 border-t border-gray-200/50 dark:border-gray-800/50 bg-white/30 dark:bg-gray-900/30 backdrop-blur-md">
    <button 
        ...
        class="w-full text-xs text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 flex items-center justify-center gap-2 p-2.5 rounded-xl hover:bg-white/50 dark:hover:bg-gray-800/50 transition-all font-medium"
    >
