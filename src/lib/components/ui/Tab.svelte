...
<div class="relative {className}">
    <div
        ...
        tabindex="0"
        class="relative flex items-center justify-start gap-1 border-b border-gray-200/70 dark:border-slate-700/70"
