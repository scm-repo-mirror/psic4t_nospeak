...
{#if isOpen}
    ...
    >
        <div 
             ...
             class="bg-white/95 dark:bg-slate-900/80 backdrop-blur-xl rounded-3xl p-8 w-full max-w-lg max-h-[80vh] flex flex-col shadow-2xl border border-white/20 dark:border-white/10 overflow-hidden relative outline-none transform-gpu will-change-transform will-change-filter transition-all duration-150 ease-out">
